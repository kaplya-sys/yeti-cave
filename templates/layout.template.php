...
<body>
  <div class="page-wrapper">
        ...
        <nav class="user-menu">
          <?php if(isset($_SESSION['user_name'])): ?>
            <div class="user-menu__logged">
              ...
              <a class="user-menu__bets" href="my-bets.php?id=<?= htmlspecialchars($_SESSION['user_id']); ?>">Мои ставки</a>
    ...
    <main class="<?php if($is_home): ?>container<?php endif; ?>">
      <?php if(!$is_home): ?><?= $navigation; ?><?php endif; ?>
      <?= $content; ?>
    </main>        
  </div>
